...
def main():
    ...
    do_ConvA(train_set=trainSet, validation_set=validationSet,
             test_set=trainSet, missingness=0.2, verbose=False,
             corrupt_method="nonblock", block_size=1, theta=1, epoch_num=50)

    do_ConvA(train_set=trainSet, validation_set=validationSet,
             test_set=trainSet, missingness=0.4, verbose=False,
             corrupt_method="nonblock", block_size=1, theta=1, epoch_num=50)

    do_ConvA(train_set=trainSet, validation_set=validationSet,
             test_set=trainSet, missingness=0.5, verbose=False,
             corrupt_method="nonblock", block_size=1, theta=1, epoch_num=50)

    do_ConvA(train_set=trainSet, validation_set=validationSet,
             test_set=trainSet, missingness=0.06, verbose=False,
             corrupt_method="block", block_size=8, theta=1, epoch_num=50)

    do_ConvA(train_set=trainSet, validation_set=validationSet,
             test_set=trainSet, missingness=0.08, verbose=False,
             corrupt_method="block", block_size=8, theta=1, epoch_num=50)

    do_ConvA(train_set=trainSet, validation_set=validationSet,
             test_set=trainSet, missingness=0.1, verbose=False,
             corrupt_method="block", block_size=4, theta=1, epoch_num=50)

    do_ConvA(train_set=trainSet, validation_set=validationSet,
             test_set=trainSet, missingness=0.15, verbose=False,
             corrupt_method="block", block_size=4, theta=1, epoch_num=50)

    do_ConvA(train_set=trainSet, validation_set=validationSet,
             test_set=trainSet, missingness=0.18, verbose=False,
             corrupt_method="block", block_size=3, theta=1, epoch_num=50)
