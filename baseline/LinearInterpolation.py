...
from my_utils import linear_interpolate
...
def main():
    ...
    linear_interpolate(test_set=testSet, missingness=0.2,
                       miss_method='nonblock', block_size=1)
    linear_interpolate(test_set=testSet, missingness=0.4,
                       miss_method='nonblock', block_size=1)
    linear_interpolate(test_set=testSet, missingness=0.5,
                       miss_method='nonblock', block_size=1)

    linear_interpolate(test_set=testSet, missingness=0.06,
                       miss_method='block', block_size=8)
    linear_interpolate(test_set=testSet, missingness=0.08,
                       miss_method='block', block_size=8)
    linear_interpolate(test_set=testSet, missingness=0.1,
                       miss_method='block', block_size=4)
    linear_interpolate(test_set=testSet, missingness=0.15,
                       miss_method='block', block_size=4)
    linear_interpolate(test_set=testSet, missingness=0.18,
